...
<div id="config" class="col-xs-12">
	<div id="config-inner" class="col-xs-12 content-padding">
		...
		<p id="config-content"><br><?php echo $installationStrings['LBL_ABOUT_VTIGER']; ?></p>
	</div>
  		
	<div id="nav-bar" class="col-xs-12 nopadding">
		<div id="nav-bar-inner" class="col-xs-12 text-right">	
			<form class="vcenter" action="install.php" method="post" name="Migrateform" id="form">
				...
				<button type="button" class="crmbutton small edit" onClick="window.document.Migrateform.submit();"><?php echo $installationStrings['LBL_MIGRATE']; ?></button>
			</form>
