			...
			<div class="col-xs-12 nopadding">
				...
				<form action="install.php" method="post" name="installform" id="form">
	          	...
	          	<div id="create_db_config" class="hide_tab">
					...
					<!-- crmv@130421 -->
					<div class="col-xs-12 col-md-6" style="padding-right:0px; padding-top:42px">
						<div class="col-xs-12 nopadding">
							<!-- Web site configuration -->
							...
							<div class="form-group">		
								<label for="account_smtp">Account</label>
								<div class="dvtCellInfo">
									<select id="account_smtp" name="account_smtp" onchange="calculateAccount(this.value,'smtp');" class="detailedViewTextBox">
							...
							<div id="account_container_smtp"></div>
						</div>
					</div>
					<!-- crmv@130421e -->					
				</form>
...
<script type="text/javascript">
	...
	function calculateAccount(value,account,seq) {
		...
		new Ajax.Request(
			'install/EmailConfig.php',
			{queue: {position: 'end', scope: 'command'},
				method: 'post',
				postBody: 'calculate_account='+value+'&account_type='+account,
