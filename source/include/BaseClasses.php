...
class VTEUniqueClass extends VTEClass implements ExtendableUniqueClass {
	...
	public static function getInstance() {
		return call_user_func_array(array(self, 'getUniqueInstance'), func_get_args());
	}
	...
	public static function getUniqueInstance() {
		...
		if (!array_key_exists($classname, self::$instances)) {
			...
			self::$instances[$classname] = call_user_func_array(array(parent, 'getInstance'), func_get_args());
		}
