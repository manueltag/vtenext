...
//crmv@96450 crmv@101683 crmv@113771 crmv@115268
var fieldValueArr=new Array('Text','TextArea','Number','Percent','Currency','Date','Email','Phone','URL','Checkbox','Picklist','MultiSelectCombo','Picklistmulti','Skype','User','AllUser','CustomUser','Group','Button','Table','AttachDocuments');
var fieldTypeArr=new Array('text','textarea','number','percent','currency','date','email','phone','url','checkbox','picklist','multiselectcombo','picklistmulti','skype','user','alluser','customuser','group','button','table','attachdocuments');
//crmv@96450e crmv@101683e crmv@113771e crmv@115268e
