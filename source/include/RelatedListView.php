...
function GetRelatedList($module,$relatedmodule,$focus,$query,$button,$returnset,$id='',$edit_val='',$del_val='') {
	...
	if($relatedmodule == 'ChangeLog'){
		return $RLU->GetChangeLogList($module, $relatedmodule, $focus, $query, $button, $returnset, $id, $edit_val, $del_val);
	} else {
		return $RLU->GetRelatedListBase($module, $relatedmodule, $focus, $query, $button, $returnset, $id, $edit_val, $del_val);
	}
	//crmv@29579e
}
