...
class PopulateComboValues
{
	...
	function create_tables () 
	{
		...
		$comboRes = $adb->query("SELECT distinct fieldname FROM ".$table_prefix."_field WHERE uitype IN ('15') OR fieldname = 'salutationtype' and ".$table_prefix."_field.presence in (0,2)");
