...
class VtigerCRMObject{
	...
	public function read($id){
		...
		// crmv@93301
		if (!$error && $this->getTabName() == 'Products') {
			$this->retrieveProductTaxes($id);
		}
		// crmv@93301e
	...
	public function create($element){
		...
		// crmv@93301
		if ($this->moduleName == 'Products' && is_array($element['taxclass'])) {
	...
	public function lookForInvitee($email, $onlyOne = false) { // crmv@68357
