...
if (empty($root_directory) || $root_directory.'index.php' != $_SERVER['SCRIPT_FILENAME']) SDK::getUtils();
//crmv@sdk-18503 e
...
function vtws_saveLeadRelations($leadId, $relatedId, $setype) {
	...
	//crmv@35141
	$skip_reference_modules = array('ChangeLog','ModNotifications','Calendar','Events');	//crmv@54739
