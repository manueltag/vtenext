...
$installationStrings = array(
	...
	'LBL_ABOUT_VTIGER' => 'VTECRM is now ready to install! <br><br>
	...
	advanced calendaring and much more.<br> Built in PHP, supports MySQL, SQL Server and Oracle.',
	'LBL_INSTALL' => 'Install',
	'LBL_MIGRATE' => 'Migrate',
	...
	'LBL_PHP_VERSION_GT_5' => 'PHP Version >= 5.3 and < 7', // crmv@111927
	'LBL_YES' => 'Yes',
	'LBL_NO' => 'No',
	...
	'MSG_HTACCESS_DETAILS' => 'This .htaccess file will work if "<b>AllowOverride All</b>" is set on Apache server configuration file (httpd.conf) for the DocumentRoot or for the current VTE path.<br>
				   				...
				   				<b>&lt;Directory "C:/Program Files/VTEcrm/apache/htdocs/VTECRM"&gt;<br>Options -Indexes<br>&lt;/Directory&gt;</b><br>
	...
	'LBL_TALK_TO_US_AT_FORUMS' => 'Talk to us at <a href="https://github.com/VTECRM/vtenext/issues" target="_blank">forums</a>',
	'LBL_DISCUSS_WITH_US_AT_BLOGS' => 'Discuss with us at <a href="https://github.com/VTECRM/vtenext/issues" target="_blank">blogs</a>',
	...
	'LBL_SOURCE_VERSION_NOT_SET' => 'Source Version is not set. Please check vteversion.php and continue the Patch Process',
	...
	'LBL_MOD_REWRITE_INSTRUCTIONS' => 'In order to enable <b>SmartOptimizer</b>, you have to set <b>AllowOverride</b> to "all" in the apache configuration file (ex. /etc/apache2/sites-available/default)',	//crmv@24713m
	...
	//crmv@130421
	'LBL_SMTP_CONFIGURATION'=>'Mail Server Settings (SMTP)',
	'LBL_OUTGOING_MAIL_SERVER'=>'Server Name',
	'LBL_OUTGOING_MAIL_PORT'=>'Port',
	'LBL_PASWRD'=>'Password',
	'LBL_REQUIRES_AUTHENT'=>'Requires Authentication',
	'LBL_SETUP_CRONJOBS'=>'Copy this line in the crontab in order to activate scheduled jobs',
	//crmv@130421e
);
?>