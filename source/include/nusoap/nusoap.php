...
class soap_server extends nusoap_base {
	...
	*/
	function serialize_return() {
		...
		// if fault
		if (isset($this->methodreturn) && (is_object($this->methodreturn) && get_class($this->methodreturn) == 'soap_fault')) {	//crmv@63421
...
class wsdl extends nusoap_base {
	...
	*/
	function addComplexType($name,$typeClass='complexType',$phpType='array',$compositor='',$restrictionBase='',$elements=array(),$attrs=array(),$arrayType='') {
		...
		if (!is_array($restrictionBase) && strpos($restrictionBase,':')) $restrictionBase = $this->expandQname($restrictionBase);
		//crmv@63421e
		...
		switch(true){
			...
			case ereg('^http',$this->endpoint):
				...
				if($err = $http->getError()){
					...
					if (!empty($this->responseData) && substr($this->responseData,-1) !== '>') $this->responseData .= '>';
					//crmv@91595e
