				...
				<td valign=top align=left >
					<table border=0 cellspacing=0 cellpadding=3 width=100% class="dvtContentSpace">
					   <tr>
						...
						<td align=left class="dvtContentSpaceInner">
								...
								<td class="blocksContainer">
									...
									{foreach item=data from=$BLOCKS}
										...
										<div style="padding:15px">
											<table border="0" cellspacing="0" cellpadding="{if $OLD_STYLE eq true}2{else}5{/if}" width=100% class="fieldsContainer small">	{* crmv@57221 *}
