...
{/if}
<div id="Buttons_List" class="vteCenterHeader" data-minified="{$toggleState}">
	...
	<table id="bl3" border=0 cellspacing=0 cellpadding=2 width=100% class="small">
		<tr height="34">
			<td align="left" valign="middle">
					...
					{foreach item=VIEW from=$MODHOMEVIEWS}
						...
						<td class="{$_class}" style="padding-right:5px" align="center" id="tdViewTab_{$VIEW.modhomeid}" nowrap="">
							<div class="dropdown">
								...
								&nbsp;
								<span data-toggle="dropdown" id="pencil_{$VIEW.modhomeid}" style="width:20px;height:18px;display:inline-block;vertical-align:text-top">
									<i class="vteicon valign-bottom md-sm md-link" style="display:none">settings</i>
								</span>
								<div class="dropdown-menu" id="editModHomeBlocks_{$VIEW.modhomeid}">
				...
				<div class="dropdown pull-left" id="add_home_views" style="padding-top:8px;padding-left:8px;display:none">
					<a data-toggle="dropdown">
						<i class="vteicon md-link" style="vertical-align:middle" data-toggle="tooltip" data-placement="bottom" title="{$APP.LBL_ADD_ITEM} tab">add</i>
						<span style="cursor:pointer">{"LBL_ADD_TAB"|getTranslatedString:"Settings"}</span>
					</a>
					<div class="dropdown-menu" id="editModHomeViews">
						<ul class="widgetDropDownList">
