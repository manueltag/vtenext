...
{* crmv@31245 crmv@10760 crmv@16312 crmv@3084m crmv@105588 crmv@124737 *}

<div id="advSearch" {if $MODULE eq 'Messages'}class="menuSeparation"{/if} style="display:none;padding:10px;">
	<form name="advSearch" method="post" action="index.php" onSubmit="totalnoofrows();return callSearch('Advanced', '{$FOLDERID}');"> {* crmv@30967 *}
			...
			<table cellspacing=0 cellpadding=5 width=100% class="small" align="center" border=0>
		        <tr>
		            ...
		            <td width="20%" align="left" {* style="padding-left:100px" *} nowrap>
