...
<script type="text/javascript">
	...
	{if !empty($KANBAN_JSON)} kanban_json = JSON.parse('{$KANBAN_JSON}'); {/if}
	GroupConditions.init(jQuery,'{$CVMODULE}','kanban_columns','#kanbanColumns',kanban_json,{ldelim}'groupLabel':true,'relatedFields':false,'groupGlue':false,'subGroup':true,'subGroupAddTitle':'{$MOD.LBL_KANBAN_ADD_DRAG_ACTION}','subGroupOperation':false,'subGroupGlue':false,'subGroupRelatedFields':false{rdelim},function(){ldelim}kanban_loaded = true;{rdelim});
</script>
{* crmv@OPER6288e *}
{literal}
<form id="customview_form" enctype="multipart/form-data" name="EditView" method="POST" action="index.php" onsubmit="if(mandatoryCheck()){VtigerJS_DialogBox.block();} else{ return false; }">	<!-- crmv@29615 crmv@29190 -->
{/literal}
...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
 <tbody><tr>
  ...
  <td class="showPanelBg" valign="top" width="100%">
   <div class="customViewContainer small" style="padding: 10px;">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="5">
		<tr>
		 	<td colspan="5" class="detailedViewHeader"><b style="font-size:16px">{$MOD.Details}</b></td>
		</tr>
		<tr>
			<td colspan=5 width="100%" style="padding:10px">
			<table cellpadding=4 cellspacing=0 width=100% border=0>
				<tr>
					<td width="10%"><span class="style1">*</span>{$MOD.LBL_VIEW_NAME}</td>
		...
		<tr>
		 <td colspan="5" class="detailedViewHeader">
		  <b style="font-size:16px">{$MOD.LBL_STEP_2_TITLE} </b>
		 </td>
		</tr>
		{literal}
		{/literal}
		<tr><td id="cv_columns" colspan="2" style="padding:10px">{include file='CustomViewColumns.tpl'}</td></tr> {* crmv@34627 *}
		<tr><td colspan="5">&nbsp;</td></tr>
		 ...
		 <td align="left" valign="top">
		  ...
		  <div id="mnuTab" {$stddiv}>
			...
			<table width="75%" border="0" cellpadding="5" cellspacing="0" align="center">
			  <tr>
			     <td width="50%" align="right" class="">{$MOD.LBL_Select_a_Column} :</td>
			     <td width="50%">
			  ...
			  <tr>
			     <td align="right" class="">{$MOD.Select_Duration} :</td>
			     <td>
			     	<div class="dvtCellInfo">
			  ...
			  <tr>
				<td align="right" class="">{$MOD.Start_Date} :</td>
				<td align=left>
					...
					{/if}
					{* crmv@100585 *}
					<input name="startdate" id="jscal_field_date_start" type="text" size="10" class="dvtCellInfo" value="{$STARTDATE}" {$msg_style}>
			  ...
			  <tr>
				<td align="right" class="">{$MOD.End_Date} :</td> 
				<td align=left>
					{* crmv@100585 *}
					<input name="enddate" {$msg_style} id="jscal_field_date_end" type="text" size="10" class="dvtCellInfo" value="{$ENDDATE}">
			  ...
			  <!-- crmv@10468 -->
			  <tr>
			  	<td align="right" class=""><label for="only_month_and_day">{$MOD.Only_Month_and_Day}</label> :</td> 
  			  	<td align=left>
   ...
   <div id="mnuTab2" {$advdiv} >
	...
	{if $REPORT_FILTER_ACCESS eq true}
		<div id="mnuTab3" style=display:none>
			<table width="100%" cellspacing="0" cellpadding="5">
				...
				<table width="75%" border="0" cellpadding="5" cellspacing="0" align="center">
					<tr>
						<td width="50%" align="right" class="">{'LBL_MODULE_NAME'|getTranslatedString:'Reports'} :</td> 
	...
	{* crmv@OPER6288e *}
  	...
  	<!-- crmv@7635 -->
	<tr><td>&nbsp;</td></tr>
	<tr><td class="detailedViewHeader" colspan="5"><b style="font-size:16px">{$MOD.LBL_ORDERBY}</b></td></tr>
	<tr class="">
...
showDateRange(getObj('stdDateFilter').options[getObj('stdDateFilter').selectedIndex].value); //crmv@95824
</script>