				...
				<div align=center>
					...
					<table border=0 cellspacing=0 cellpadding=5 width=100% class="settingsSelUITopLine">
						<tr>
							...
							<td class=heading2 valign=bottom><b> {$MOD.LBL_SETTINGS} > {$MOD.LBL_SHARING_ACCESS} </b></td>
							<!-- crmv@30683 -->
							...
							<table border=0 cellspacing=0 cellpadding=5 width=100% class="tableHeading">
								<tr>
									...
									<td class="small" align="right">
										...
										&nbsp;<input class="crmButton small edit" type="submit" name="Edit" value="{$CMOD.LBL_CHANGE} {$CMOD.LBL_PRIVILEGES}" >
									</td>
								</tr>
							</table>
					...
					<div id="customdiv">
						...
						<table width="100%" class="table">
							...
							<tr>
								...
								<td class="">
									<a href="javascript:void(0);" onClick="callEditDiv(this,'{$modulename}','edit','{$elements.0}')"><i class="vteicon" title='edit'>create</i></a> <a href='javascript:confirmdelete("index.php?module=Users&action=DeleteSharingRule&shareid={$elements.0}")'><i class="vteicon" title='del'>delete</i></a>
								</td>
							</tr>
							{/foreach}
						</table>
...
<div id="confId"  class="" style="display:none;">
<table class="options small" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td align="center">
			...
			<input type="button" class="crmbutton edit small" value="&nbsp;{$CMOD.LBL_NO}&nbsp;" onclick="unFreezeBackground();">
		</td>
	</tr>
</table>
</div>
...
function freezeBackground() {ldelim}
	// crmv@97217
    showFloatingDiv('confId', null, {ldelim}
		modal: true, 
	{rdelim});
...
function unFreezeBackground() {ldelim}
	// crmv@97217
    hideFloatingDiv('confId');
    showSelect();
    // crmv@97217e
{rdelim}
