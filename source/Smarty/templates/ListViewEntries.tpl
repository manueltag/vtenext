					...
					<td width="33%" align="right">
		                ...
		                <table border=0 cellspacing=0 cellpadding=0 class="small"><tr>
							...
							<td>
								...
								{if $HIDE_CUSTOM_LINKS neq '1'}
									<i data-toggle="tooltip" class="vteicon md-link" id="filter_option_img" title="{$APP.LBL_FILTER_OPTIONS}" onmouseover="fnDropDown(this,'customLinks',-18);" onmouseout="fnHideDrop('customLinks');" >settings</i>
								{/if}
