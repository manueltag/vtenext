...
<table border=0 cellspacing=0 cellpadding=5 width=100% class="layerPopupTransport">
	<tr>
		...
		<input type="submit" class="crmButton small save" name="add" value="{$mod_strings.LBL_ADD_RULE}" onclick="updateAllColumnField();jQuery('form#customview_form input[name=record]').val('');">&nbsp;&nbsp;
	</td>
	</tr>
</table>
</form></div>
...
{if $mode eq 'edit'}
	...
	if (currOption.value != '') changeColumnField('{$module}', currField.value, '1', currOption.value);

	var selObj = document.getElementById('fop2');
    var currOption = selObj.options[selObj.selectedIndex];
    var currField = document.getElementById('fcol2');
	if (currOption.value != '') changeColumnField('{$module}', currField.value, '2', currOption.value);

	var selObj = document.getElementById('fop3');
    var currOption = selObj.options[selObj.selectedIndex];
    var currField = document.getElementById('fcol3');
	if (currOption.value != '') changeColumnField('{$module}', currField.value, '3', currOption.value);

	var selObj = document.getElementById('fop4');
    var currOption = selObj.options[selObj.selectedIndex];
    var currField = document.getElementById('fcol4');
	if (currOption.value != '') changeColumnField('{$module}', currField.value, '4', currOption.value);

	var selObj = document.getElementById('fop5');
    var currOption = selObj.options[selObj.selectedIndex];
    var currField = document.getElementById('fcol5');
	if (currOption.value != '') changeColumnField('{$module}', currField.value, '5', currOption.value);
{else}
