...
<head>
	...
	{/literal}
	<!-- End -->
	<script language="JavaScript" type="text/javascript" src="include/js/jquery.js"></script>	{* crmv@22022 *}
</head>
...
<script src="{"include/js/general.js"|resourcever}" type="text/javascript"></script>
...
{else}
	...
	<div style='border: 3px solid rgb(153, 153, 153); background-color: rgb(255, 255, 255); width: 55%; position: relative; z-index: 10000000;'>
		...
		<a href='javascript:closePopup();'>{$APP.LBL_GO_BACK}</a><br>	{* crmv@22022 *}
		</td>
		</tr>
		</tbody></table>
	</div>
