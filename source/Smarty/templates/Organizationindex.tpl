...
<tr>
<td class="detailedViewHeader" align="left" colspan=2><b> {$MOD.LBL_SETTINGS}  > {$MOD.LBL_USER_MANAGEMENT} > {$MOD.LBL_DEFAULT_ORGANIZATION_FIELDS}</b></td></tr> <!-- crmv@30683 -->
<tr>
<td>
...
<a href="index.php?module=Users&action=DefaultFieldPermissions&fld_module=Notes">{$MOD.LBL_NOTE_FIELD_ACCESS}</a></td><td>
