...
<title>{$MOD.TITLE_VTIGERCRM_SMS}</title>
...
<tbody>
   ...
   <tr>
	...
	<td class="dvtCellLabel" style="padding: 5px;">&nbsp;{$TO_SMS}</td>
	<td class="dvtCellLabel" width="20%" rowspan="4"><div id="attach_cont_sms" class="addEventInnerBox" style="overflow:auto;height:140px;width:100%;position:relative;left:0px;top:0px;"></td>
   </tr>
   ...
   <tr>
	<td colspan="3" class="dvtCellLabel" style="padding: 10px;" align="center"><input type="button" name="forward" value=" {$MOD.LBL_FORWARD_BUTTON} " alt="{$MOD.LBL_FORWARD_BUTTON}" title="{$MOD.LBL_FORWARD_BUTTON}" class="crmbutton small edit" onClick=OpenComposeSms('{$ID}','forward')>&nbsp;
	<input type="button" title="{$APP.LBL_EDIT}" alt="{$APP.LBL_EDIT}" name="edit" value=" {$APP.LBL_EDIT} " class="crmbutton small edit" onClick=OpenComposeSms('{$ID}','edit')>&nbsp;
   ...
   <tr><td colspan="3">
   	<div id="attach_temp_cont_sms" style="display:none;">
...
<script>
$('attach_cont_sms').innerHTML = $('attach_temp_cont_sms').innerHTML;
</script>
