...
<form enctype="multipart/form-data" name="mergeDuplicates" method="post" action="index.php?module={$MODULE}&action=FindDuplicateRecords" onsubmit="VtigerJS_DialogBox.block();">
	...
	<table class="searchUIBasic small" border="0" cellpadding="5" cellspacing="0" width="100%" height="10" align="center">
	   ...
	   <tr><td colspan="3"></td></tr>
		...
		<tr class="lvtCol" style="Font-Weight: normal">
			<td colspan="2">
				<span font-weight:normal>{$APP.LBL_SELECT_MERGECRITERIA_EMPTY}</span>
	   ...
	   {*//crmv@36508 e*}			
		<tr>
			...
			<input type="submit" name="save" value="{$APP.SAVE_MERGE_FIELDS}" class="crmbutton small edit" type="button" onClick="return SaveMergeFields();">
