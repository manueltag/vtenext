	...
	<div align=center>
			...
			{include file='Buttons_List.tpl'} {* crmv@30683 *} 
				...
				<tr>
					...
					<td class=heading2 valign=bottom><b> {$MOD.LBL_SETTINGS} > <a href="index.php?module=Settings&action=listwordtemplates&parenttab=Settings">{$UMOD.LBL_WORD_TEMPLATES}</a> > {$UMOD.LBL_NEW_TEMPLATE} </b></td> <!-- crmv@30683 -->
				</tr>
				<tr>
