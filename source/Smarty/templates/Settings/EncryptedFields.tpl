	...
	<tr>
		...
		<td class="showPanelBg" style="padding: 5px;" valign="top" width="100%">
			<div align="center">
				...
				<table border="0" cellspacing="0" cellpadding="5" width="100%" class="settingsSelUITopLine">
					<tr>
						<td width=50 rowspan=2 valign=top>
							<img src="{$IMAGE_PATH}uitype208.png" alt="LBL_EDIT_UITYPE208" width="48" height="48" border=0 title="{$MOD.LBL_PROFILES}">
						</td>
				...
				<script>
					var euHandle = document.getElementById("encField_DelForm_Handle");
					var euRoot   = document.getElementById("encField_DelForm_div");
					Drag.init(euHandle, euRoot);
				</script>
