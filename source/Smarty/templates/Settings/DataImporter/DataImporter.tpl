...
<tr>
	...
	<div align=center>
		...
		<table class="settingsSelUITopLine" border="0" cellpadding="5" cellspacing="0" width="100%">
			<tr>
				<td rowspan="2" valign="top" width="50"><img src="{'data_import.png'|@vtiger_imageurl:$THEME}" alt="{$MOD.LBL_DATA_IMPORTER}" title="{$MOD.LBL_DATA_IMPORTER}" border="0" height="48" width="48"></td>
