...
<tr>
	...
	<div align=center>
		...
		<table class="settingsSelUITopLine" border="0" cellpadding="5" cellspacing="0" width="100%">
			<tr>
				<td rowspan="2" valign="top" width="50"><img src="{'module_maker.png'|@vtiger_imageurl:$THEME}" alt="{$MOD.LBL_MODULE_MAKER}" title="{$MOD.LBL_MODULE_MAKER}" border="0" height="48" width="48"></td>
