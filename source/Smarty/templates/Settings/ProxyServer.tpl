      			    ...
      			    <td class="small" valign=top>
						...
						<tr>
                            ...
                            <td class="small cellText">
                            	<div class="dvtCellInfo">
									{* crmv@43764 *}
									<input type="password" value="{if !empty($PROXYPASSWORD)}********{/if}" class="detailedViewTextBox small" onFocus="this.value='';" onChange="document.getElementById('server_password').value=this.value;" />
