...
<!-- in setMenu table is opened and ends with one open td tag -->
		...
		<tr>
			<td width=50 rowspan=2 valign=top><img src="{'menuSettings.gif'|@vtiger_imageurl:$THEME}" width="48" height="48" border=0 ></td>
        ...
        <div width="100%" height="30%" align="right">
	        <input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accesskey="{$APP.LBL_SAVE_BUTTON_KEY}" class="small crmbutton save"  name="button" value="{$APP.LBL_SAVE_BUTTON_LABEL}" onclick="VtigerJS_DialogBox.block(); selectModuleLists(); this.form.action.value='SaveParentTabs'; this.form.submit();" style="min-width: 70px;" type="button" />
