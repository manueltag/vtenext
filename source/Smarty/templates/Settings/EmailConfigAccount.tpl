	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="5">
		{if $MAILSERVERNOTE neq ''}
			<tr>
				...
				<td width="80%" class="small cellText"><span class="helpmessagebox" style="font-style: italic;">{$MAILSERVERNOTE|getTranslatedString:'Settings'}</span></td>
			</tr>
		{/if}
		<tr>
...
{elseif $SERVER_ACCOUNT eq 'imap'}
	<tr id="imap_account_div_{$i}">
		...
		<td class="small cellText">
			<div class="dvtCellInfo">
				<select name="account_imap_{$i}" onchange="calculateAccount(this.value,'imap',{$i});" class="detailedViewTextBox">
		...
		<td class="small cellText">
			<div class="dvtCellInfo">
				<input type="text" class="detailedViewTextBox small" value="{$account.server}" name="server_imap_{$i}">
			</div>
		</td>
		<td class="small cellText">
			<div class="dvtCellInfo">
				<input type="text" class="detailedViewTextBox small" value="{$account.port}" name="port_imap_{$i}">
			</div>
		</td>
		<td class="small cellText">
			<div class="dvtCellInfo">
		...
		<td class="small cellText">
			<div class="dvtCellInfo">
				<input type="text" class="detailedViewTextBox small" value="{$account.domain}" name="domain_{$i}">
			</div>
		</td>
	</tr>
{/if}