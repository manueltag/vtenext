		...
		{foreach item=entries key=id from=$CFENTRIES name=outer}
			{if $entries.blockid ne $RELPRODUCTSECTIONID || $entries.blocklabel neq '' }
				...
				<tr>
					...
					<td class="colHeader small" colspan="2" align="right" width="50%">
						...
						{if $entries.hascustomtable && $entries.blockid neq $COMMENTSECTIONID && $entries.blockid neq $SOLUTIONBLOCKID && $FORMOBILE neq true}
						...
						{if $entries.blockid neq $COMMENTSECTIONID && $entries.blockid neq $SOLUTIONBLOCKID && $FORMOBILE neq true}
					...
					<td class="dvInnerHeader">
						<div style="float:left;font-weight:bold;">
							<div class="vcenter" style="margin-right:5px">
								<i class="vteicon icon-module icon-{$REL.module|strtolower}" data-first-letter="{$REL.module[0]|strtoupper}"></i>				
							</div>
