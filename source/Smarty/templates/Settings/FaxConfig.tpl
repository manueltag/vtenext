...
<tbody><tr>
	...
	<form action="index.php" method="post" name="FaxServer" id="form" onsubmit="VtigerJS_DialogBox.block();">
	<input type="hidden" name="faxconfig_mode">
	{else}
	{literal}
	<form action="index.php" method="post" name="FaxServer" id="form" onsubmit="if(validate_fax_server(SmsServer)){ VtigerJS_DialogBox.block(); return true; } else { return false; }">
	{/literal}		
	...
	<div align=center>
			...
			{include file='Buttons_List.tpl'} {* crmv@30683 *} 
				...
				<tr>
					<td width=50 rowspan=2 valign=top><img src="{$IMAGE_PATH}ogfaxserver.gif" alt="{$MOD.LBL_USERS}" width="48" height="48" border=0 title="{$MOD.LBL_USERS}"></td>
					<td class=heading2 valign=bottom><b> {$MOD.LBL_SETTINGS} > {$MOD.LBL_FAX_SERVER_SETTINGS} </b></td> <!-- crmv@30683 -->
				</tr>
				<tr>
					<td valign=top class="small">{$MOD.LBL_FAX_SERVER_DESC} </td>
				</tr>
				</table>
				...
				<td>
					...
					<tr>
						...
						<td class="small" align=right>
							<input class="crmButton small edit" title="{$APP.LBL_EDIT_BUTTON_TITLE}" accessKey="{$APP.LBL_EDIT_BUTTON_KEY}" onclick="this.form.action.value='FaxConfig';this.form.faxconfig_mode.value='edit'" type="submit" name="Edit" value="{$APP.LBL_EDIT_BUTTON_LABEL}">
						</td>
						{else}
						<td class="small" align=right>
					...
					<td class="small" valign=top ><table width="100%"  border="0" cellspacing="0" cellpadding="5">
                          <tr>
                            <td width="20%" nowrap class="small cellLabel"><strong>{$MOD.LBL_OUTGOING_FAX_SERVER_TYPE}</strong></td>
                            <td width="80%" class="small cellText"><strong>{$MOD.$FAXSERVERTYPE}&nbsp;</strong></td>
                          </tr>					
                          <tr>
                            <td width="20%" nowrap class="small cellLabel"><strong>{$MOD.LBL_OUTGOING_FAX_SERVER}</strong></td>
                            <td width="80%" class="small cellText"><strong>{$FAXSERVER}&nbsp;</strong></td>
                          </tr>
                          <tr valign="top">
			...
			<td class="small" valign=top ><table width="100%"  border="0" cellspacing="0" cellpadding="5">
                        <tr>
                            <td width="20%" nowrap class="small cellLabel"><font color="red">*</font>&nbsp;<strong>{$MOD.LBL_OUTGOING_FAX_SERVER_TYPE}</strong></td>
                        ...
                        <tr>
                            <td width="20%" nowrap class="small cellLabel"><font color="red">*</font>&nbsp;<strong>{$MOD.LBL_OUTGOING_FAX_SERVER}</strong></td>
                            <td width="80%" class="small cellText">
                            	<div class="dvtCellInfo">
									<input type="text" class="detailedViewTextBox small" value="{$FAXSERVER}" name="server">
								</div>
			   				</td>
                          </tr>
                          <tr valign="top">
			...
			{/if}
					...
					<tr>
					<td class="small" valign=top ><table width="100%"  border="0" cellspacing="0" cellpadding="5">
                            <td width="20%" nowrap class="small cellLabel"><strong>{$MOD.LBL_FAX_DOMAIN}</strong></td>
                            <td width="80%" class="small cellText"><strong>{$ADVDOMAIN}&nbsp;</strong></td>
                          </tr>
                          <tr valign="top">
                            <td nowrap class="small cellLabel"><strong>{$MOD.LBL_FAX_ACCOUNT}</strong></td>
                            <td class="small cellText">{$ADVACCOUNT}&nbsp;</td>
                          </tr>
                          <tr>
                          <tr>
                            <td width="20%" nowrap class="small cellLabel"><strong>{$MOD.LBL_FAX_PREFIX}</strong></td>
                            <td width="80%" class="small cellText"><strong>{$ADVPREFIX}&nbsp;</strong></td>
                          </tr>					
                          <tr>                          
                            <td nowrap class="small cellLabel"><strong>{$MOD.LBL_FAX_NAME}</strong></td>
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="5">
						<tr>
                            <td width="20%" nowrap class="small cellLabel"><font color="red">*</font>&nbsp;<strong>{$MOD.LBL_FAX_DOMAIN}</strong></td>
                            <td width="80%" class="small cellText">
                            	<div class="dvtCellInfo">
                          ...
                          <tr>
                            <td nowrap class="small cellLabel"><font color="red">*</font>&nbsp;<strong>{$MOD.LBL_FAX_ACCOUNT}</strong></td>
                            <td class="small cellText">
                            	<div class="dvtCellInfo">
