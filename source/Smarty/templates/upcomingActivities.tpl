...
<div id='todayUpcoming'>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
        	<tr width="100%">
                	...
                	<td align="left"><img src="{$IMAGE_PATH}upcoming_left.gif" align="top"></td>
			<td width="1000px"  background="{$IMAGE_PATH}upcomingEvents.gif" style="background-repeat:repeat-x;"></td>
			<td align="right"><img src="{$IMAGE_PATH}upcoming_right.gif" align="top"></td>
		</tr>
		<tr>
