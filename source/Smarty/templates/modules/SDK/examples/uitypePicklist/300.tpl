...
{elseif $sdk_mode eq 'edit'}
	...
	{else}
		...
		<div class="{$DIVCLASS}">
			<select name="{$fldname}" tabindex="{$vt_tab}" class="detailedViewTextBox" onchange="linkedListChainChange(this, '{$MODULE}')"> {* crmv@30528 *}
		...
		<script type="text/javascript">
			(function() {ldelim}
				...
				if (lastpl.length > 0) linkedListChainChange(lastpl[0], '{$MODULE}'); // crmv@30528
			{rdelim})();
		</script>
	{/if}
{/if}
