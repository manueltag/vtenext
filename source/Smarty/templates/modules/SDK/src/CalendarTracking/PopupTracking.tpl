...
<div id="trackerPopup" style="display:none; position:fixed;" class="crmvDiv">
	<table border="0" cellpadding="5" cellspacing="0" width="100%">
		<tr style="cursor:move;" height="34">
			<td id="trackerPopup_Handle" style="padding:5px;color:#000000;font-size:14px" class="level3Bg" align="left">
...
<script type="text/javascript">
	(function() {ldelim}
		var tpHandle = document.getElementById("trackerPopup_Handle");
		var tpRoot   = document.getElementById("trackerPopup");
		Drag.init(tpHandle, tpRoot);
	{rdelim})();
</script>