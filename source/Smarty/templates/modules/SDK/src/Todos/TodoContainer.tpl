...
<style type="text/css">
	...
	.todobtn_image_duration {
		{/literal}
		background-image:  url('themes/{$THEME}/images/todo_hourglass.png');
		{literal}
	}
	.todobtn_image_calendar {
		{/literal}
		background-image:  url('themes/{$THEME}/images/todo_calendar.png');
		{literal}
	}
	.todobtn {
		display: inline-block;
...
<script>
	var Handle = document.getElementById("Todos_Handle");
