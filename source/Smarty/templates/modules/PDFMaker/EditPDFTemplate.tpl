				...
				<td> 
		                    ...
		                    <tr>
			          			  ...
			          			  <td width=80% class="small cellText">
			          			  	<div class="dvtCellInfoM">
			          			  		<input name="filename" id="filename" type="text" value="{$FILENAME}" class="detailedViewTextBox" tabindex="1">
			          			  	</div>
			          			  </td>
		          			 </tr>
		          			 <tr>
                      ...
                      <div style="display:none;" id="company_div">
    					...
    					<tr>
    						...
    						<td class="cellText small" valign=top>
        						...
        						<input type="button" value="{$MOD.LBL_INSERT_BARCODE_TO_TEXT}" class="crmButton small create" onclick="InsertIntoTemplate('barcodeval');">&nbsp;&nbsp;
                      ...
                      <div style="display:none;" id="settings_div">
    					...
    					*}
    					...
    					<tr>
    					   ...
    					   <td class="cellText small" valign="top" title="{$MOD.LBL_IGNORE_PICKLIST_VALUES_DESC}">
    					   	<div class="dvtCellInfo">
                    ...
                    <script type="text/javascript">
                    	...
                    	{php} if (file_exists("kcfinder/browse.php")) { {/php}
                            {literal} CKEDITOR.replace( 'body',{customConfig:'../../modules/PDFMaker/fck_config_kcfinder.js',language : curr_lang} );  {/literal} {php} } else { {/php} 
                            {literal} CKEDITOR.replace( 'body',{customConfig:'../../modules/PDFMaker/fck_config.js',language : curr_lang} ); {/literal}
                        {php} } {/php}
                        {*//crmv@35764 e*}                 
                    </script>
...
{    
    new Ajax.Request(
                ...
                {queue: {position: 'end', scope: 'command'},
                        method: 'post',
                        postBody: 'module=PDFMaker&action=PDFMakerAjax&file=AjaxRequestHandle&langmod='+module,
