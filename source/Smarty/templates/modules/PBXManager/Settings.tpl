        ...
        <td class="showPanelBg" style="padding: 5px;" valign="top" width="100%"> <!-- crmv@30683 -->
			...
			<div align=center>
				...
				<table border=0 cellspacing=0 cellpadding=5 width=100% class="settingsSelUITopLine">
					<tr>
						<td width=50 rowspan=2 valign=top><img src="{'ogasteriskserver.gif'|@vtiger_imageurl:$THEME}" alt="{$MOD.LBL_SOFTPHONE_SERVER_SETTINGS}" width="48" height="48" border=0 title="{$MOD.LBL_SOFTPHONE_SERVER_SETTINGS}"></td>	{* crmv@22660 *}
							...
							<table border=0 cellspacing=0 cellpadding=0 width=100% class="listRow">
								<tr>
			                        ...
			                        <tr>
                						...
                						<td width="80%" class="small cellText">
											{* crmv@43764 *}
											<input type="password" value="{if !empty($ASTERISK_PASSWORD)}********{/if}" class="small" style="width:30%" onFocus="this.value='';" onChange="document.getElementById('asterisk_password').value=this.value;" />
