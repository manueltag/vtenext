...
<tr>
	...
	<td class="showPanelBg" valign=top width=100% style="padding:0px">
		...
		<div class="small" style="padding:0px">
			<table align="center" border="0" cellpadding="4" cellspacing="0" width="100%" class="level3Bg" id="Buttons_List_4" style="position:fixed;z-index:19;">
			<tr>
