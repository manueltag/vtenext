...
<tr>
	...
	<tr>
		...
		<input name="assigntype" checked value="U" onclick="toggleAssignType(this.value)" type="radio">&nbsp;User
		
		{if count($GROUPS) > 0}
			<input name="assigntype"  value="T" onclick="toggleAssignType(this.value)" type="radio">&nbsp;Group
		{/if}
