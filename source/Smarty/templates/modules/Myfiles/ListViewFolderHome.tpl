	...
	<div id="lview_folder_addcont">
		...
		<table cellpadding="5" cellspacing="0" class="hdrNameBg" >
			<tr>
				...
				<td><input type="text" maxlength="20" name="foldername" value="" /></td>
			</tr>
			<tr>
				<td>{$APP.LBL_DESCRIPTION}</td>
				<td><input type="text" maxlength="50" name="folderdesc" value="" /></td>
			</tr>
		</table>
		</form>
	</div>
...
<div id="lview_table_cont" class="small lview_folder_table">
	...
	{foreach item=folder from=$FOLDERLIST}
		<div class="lview_folder_td dropzone_target" folderid="{$folder.folderid}">
			<div>
				<a class="folder" folderid="{$folder.folderid}" foldername="{$folder.foldername}" href="javascript:"><img class="lview_folder_img" src="modules/Myfiles/src/img/folder_icon.png" border="0" /></a><br />
			</div>
			<div>
