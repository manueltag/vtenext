 ...
 ***************************************************************************************}
{* crmv@104562 *}
{* in all the js files replace "$." with "jQuery." and "$(" with "jQuery(" *}
...
<div id="GanttTab" style="display:none">
	...
	<div id="workSpaceGantt" style="padding:0px; overflow-y:auto; overflow-x:hidden;border:1px solid #e5e5e5;position:relative;margin:0 5px"></div>
