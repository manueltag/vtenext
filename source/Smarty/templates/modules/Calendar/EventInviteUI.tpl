												...
												<table cellpadding="3" cellspacing="0" class="small">
													<tr>
														<td rowspan="2" valign="middle">
															<i class="vteicon icon-module icon-contacts" data-first-letter="C"></i>
														</td>
...
<script type="text/javascript">
	...
	function addInvitee(id, mode, item) {
		...
		if (item.img) {
			...
			span += '<i class="vteicon icon-module icon-' + modeLow + '" data-first-letter="' + moduleFirst + '"></i>';
		}
		span += '</td>';
