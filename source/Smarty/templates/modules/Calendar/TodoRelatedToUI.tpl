...
<table width="100%" cellpadding="5" cellspacing="0" border="0">
	...
	{assign var="popup_params" value="&action=Popup&maintab=Calendar"}
	<tr>
		<td width="15%" nowrap>
				...
				<tr>
					<td width="40%" class="dvtCellInfo" style="padding: 0px 5px; vertical-align: middle; text-align: center;">
						...
						<div class="dvtCellInfo">
							<select name="parent_type" class="small detailedViewTextBox" id="parent_type" onChange="reloadAutocomplete(document.createTodo.parent_id,document.createTodo.parent_name,'module='+this.value+'{$popup_params}');document.createTodo.parent_name.value='';document.createTodo.parent_id.value='';enableReferenceField(document.createTodo.parent_name);">
								{foreach item=combo key=id_pa from=$LABEL.parent_id.options} {if $selected_mod eq $combo} {assign var=selected_v value='selected'} {else} {assign var=selected_v value=''} {/if}
