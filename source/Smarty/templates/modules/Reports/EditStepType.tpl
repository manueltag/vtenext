...
<table border="0" width="100%">
	...
	<tr>
		<td class="dimport_step_field_cell" align="right" width="30%">
			<img src="{'tabular.gif'|@vtiger_imageurl:$THEME}" align="absmiddle" onclick="jQuery('#reportTypeTab').click()">
		</td>
	...
	<tr>
		<td class="dimport_step_field_cell" align="right">
			<img src="{'summarize.gif'|@vtiger_imageurl:$THEME}" align="absmiddle" onclick="jQuery('#reportTypeSum').click()">
		</td>
