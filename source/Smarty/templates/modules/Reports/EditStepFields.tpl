...
<table border="0" width="100%" align="center">
	...
	<tr>
		...
		<td>
			<select id="availfields" class="notdropdown" size="8" multiple="" style="min-width:600px">
			</select>
		</td>
			...
			<tr height="25">
				<td class="fieldname">
					...
					<div>
						...
						<span class="fieldLabel vcenter"><i name="fieldIcon" class="vteicon icon-module icon-{$fld.module|strtolower}" data-first-letter="{$first_letter}"></i></span>
		...
		<table cellspacing="0" cellpadding="0" width="100%">
			<tr height="25">
				<td class="fieldname">
					...
					<div>
						<span class="fieldLabel vcenter"><i name="fieldIcon" class="vteicon icon-module"></i></span>
