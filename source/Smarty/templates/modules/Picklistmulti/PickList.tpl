...
<script src="include/js/jquery_plugins/jqgrid/i18n/grid.locale-{$LANGUAGE_SUFFIX}.js" type="text/javascript"></script>
...
<tbody><tr>
	...
	<div align=center>
		...
		<tr>
			<td width=50 rowspan=2 valign=top><img src="{'picklist_multilanguage.gif'|@vtiger_imageurl:$THEME}" width="48" height="48" border=0 ></td>
