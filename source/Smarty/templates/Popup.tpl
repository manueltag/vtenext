...
<script type="text/javascript" src="include/js/Mail.js"></script> {* crmv@21048m *}
	...
	<tr>
		<td class="nopadding">
						...
						<div id="searchAcc" style="position:relative;">
							...
							<!-- //crmv@16312 end -->
								...
								<tr>
									...
									<a href="#" onClick="fnhide('searchAcc');window.show('advSearch');updatefOptions(document.getElementById('Fields0'), 'Condition0');document.basicSearch.searchtype.value='advance';"> <!-- crmv@98866 -->
										<img src="{$IMAGE_PATH}basicSearchLens.gif" alt="{$APP.LBL_GO_TO} {$APP.LNK_ADVANCED_SEARCH}" title="{$APP.LBL_GO_TO} {$APP.LNK_ADVANCED_SEARCH}" border="0">
									</a>
									</td>
								...
								<tr>
									<td colspan="5" align="center">
										<table width="100%" class="small table-fixed">
										<tr>
											{$ALPHABETICAL}
										</tr>
										</table>
								...
								<table width="100%" cellpadding="0" cellspacing="0">
						            <tr class="small">
										<td width="20%" class="dvtCellLabel" valign="top">
											<a href="#" onClick="window.show('searchAcc');fnhide('advSearch')"> <!-- crmv@98866 -->
												<img src="{$IMAGE_PATH}advancedSearchLens.gif" alt="{$APP.LBL_GO_TO} {$APP.LNK_BASIC_SEARCH}" title="{$APP.LBL_GO_TO} {$APP.LNK_ADVANCED_SEARCH}" border="0">
											</a>
										</td>
						                <td class="dvtCellLabel" width="80%" colspan="3">
											...
											<div id="fixed" style="position:relative;width:100%;height:60px;padding:0px; overflow:auto;border:1px solid #CCCCCC; class="small">
			...
			{if $QUICKCREATE eq 'permitted'}
				<div id="qcform" style="position:absolute;top:80px;left:50px;z-index:89999;display:none;"></div>
				<div id="create" align="left" style="padding: 10px;">
					...
					<a href="javascript:;" onclick="QCreate('{$MODULE}');">
						<img border="0" title="Crea" alt="Crea" src="{$THEME_PATH}images/btnL3Add.gif">
					</a>
				</div>
			{/if}
			<!-- crmv@16265e -->
...
{ldelim}
	...
	gsorder=url;
  var urlstring ="module="+module+"&action="+module+"Ajax&file=Popup&ajax=true"+url;
  urlstring +=gethiddenelements();  <!-- DS-CR VlMe 27.3.2008 -->
...
function updateIdstrings(obj,entityid)
{ldelim}
...
function saveRelation(mod,parmod)
{ldelim}
	{* crmv@21048m *}
	...
	if(module != 'none'){
		...
		jQuery.ajax({
			...
			success: function(response){
				...
				jQuery("#qcform")[0].style.display="inline";
				jQuery("#qcform").html(response);
				posLay(getObj('create'), "qcform");
				jQuery('#qcform').css('left', '+=16');	// crmv@104070 - leave space for the X
