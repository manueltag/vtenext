...
<script language="JavaScript" type="text/javascript" src="modules/com_vtiger_workflow/resources/vtigerwebservices.js"></script>
...
function toggleEmailSettings(templatetype) {
