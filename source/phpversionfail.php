...
<head>
	...
	<title>VTE CRM - PHP Version Check</title>
...
<body class="small cwPageBg" topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
	...
	<tr>
		<td class="small" bgcolor="#FFFFFF" align=center>
			PHP 5.3 or above is required. Your current PHP version is <?php echo phpversion() ?> <br/>
	...
	<tr>
    	...
    	<table border=0 cellspacing=0 cellpadding=0 width=80% align=center>
      	...
      	<tr>
        	<td class=small align=center> <a href="http://www.vtecrm.com" target="_blank">www.vtecrm.com</a></td>
      	</tr>
    	</table>
</body>
</html>