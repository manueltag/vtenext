...
global $mod_strings, $app_strings, $currentModule, $current_user, $theme, $singlepane_view, $current_account, $current_folder;
...
$smarty->assign('CUSTOM_LINKS', Vtiger_Link::getAllByType(getTabid($currentModule), Array('DETAILVIEWWIDGET'), $customlink_params));
// END
...
if ($_REQUEST['mode'] == 'ListView') {
	$_SESSION['autoload_message'] = $record;	//crmv@50101
