...
function PDFViewerPlugin() {
    ...
    function init(callback) {
        ...
        loadScript('modules/Messages/src/ViewerJS/compatibility.js', function () { //crmv@62414
            loadScript('modules/Messages/src/ViewerJS/pdf.js'); //crmv@62414
            loadScript('modules/Messages/src/ViewerJS/pdf_find_bar.js'); //crmv@62414
            loadScript('modules/Messages/src/ViewerJS/pdf_find_controller.js'); //crmv@62414
            loadScript('modules/Messages/src/ViewerJS/ui_utils.js'); //crmv@62414
            loadScript('modules/Messages/src/ViewerJS/text_layer_builder.js'); //crmv@62414
            loadScript('modules/Messages/src/ViewerJS/pdfjsversion.js', callback); //crmv@62414
        });

        pluginCSS = document.createElement('link');
        pluginCSS.setAttribute("rel", "stylesheet");
        pluginCSS.setAttribute("type", "text/css");
        pluginCSS.setAttribute("href", "modules/Messages/src/ViewerJS/PDFViewerPlugin.css"); //crmv@62414
    ...
    this.initialize = function (viewContainer, location) {
        ...
        init(function () {
            PDFJS.workerSrc = "modules/Messages/src/ViewerJS/pdf.worker.js"; //crmv@62414
