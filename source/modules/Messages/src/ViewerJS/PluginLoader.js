...
function loadDocument(documentUrl) {
    ...
    if (documentUrl) {
        ...
        case 'fods':
        case 'ots':
            loadPlugin('modules/Messages/src/ViewerJS/ODFViewerPlugin', function () { //crmv@62414
                Plugin = ODFViewerPlugin;
            });
            break;
        case 'pdf':
            loadPlugin('modules/Messages/src/ViewerJS/PDFViewerPlugin', function () { //crmv@62414
