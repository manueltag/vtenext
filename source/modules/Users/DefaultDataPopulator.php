...
class DefaultDataPopulator extends CRMEntity {
	...
	function create_tables () {
		...
		$modules = array(
			array(1,	'Dashboard',	1,12,	'Dashboards',	0,1,0),
		...
		$blocks = array(
			...
			array(0,14,'LBL_PRICING_INFORMATION',2,0,0,0),
			array(0,14,'LBL_STOCK_INFORMATION',3,0,0,0),
			array(0,14,'LBL_CUSTOM_INFORMATION',4,0,0,0),
			array(0,14,'LBL_IMAGE_INFORMATION',5,0,0,0),
			array(0,14,'LBL_DESCRIPTION_INFORMATION',6,0,0,0),
		...
		//$this->db->query("insert into ".$table_prefix."_field values (6,".$this->db->getUniqueID($table_prefix."_field").",'tickersymbol','".$table_prefix."_account',1,'1','tickersymbol','Ticker Symbol',1,2,0,100,5,9,1,'V~O',1,null,'BAS',1,'')");
		...
		$this->db->query("insert into ".$table_prefix."_field values (6,".$this->db->getUniqueID($table_prefix."_field").",'external_code','".$table_prefix."_account',1,'1112','external_code','External Code',1,2,0,100,22,9,1,'V~O',1,null,'BAS',1,'')");
		...
		$this->db->query("insert into ".$table_prefix."_field values (6,".$this->db->getUniqueID($table_prefix."_field").",'newsletter_unsubscrpt','".$table_prefix."_account',1,'56','newsletter_unsubscrpt','Receive newsletter',1,2,0,100,23,9,1,'C~O',3,null,'BAS',0,'')");	//crmv@55961	
		$this->db->query("insert into ".$table_prefix."_field values (6,".$this->db->getUniqueID($table_prefix."_field").",'smownerid','".$table_prefix."_crmentity',1,'53','assigned_user_id','Assigned To',1,0,0,100,24,9,1,'I~M',1,null,'BAS',1,'')");
		$this->db->query("insert into ".$table_prefix."_field values (6,".$this->db->getUniqueID($table_prefix."_field").",'createdtime','".$table_prefix."_crmentity',1,'70','createdtime','Created Time',1,0,0,100,26,9,2,'T~O',3,null,'BAS',0,'')");
		$this->db->query("insert into ".$table_prefix."_field values (6,".$this->db->getUniqueID($table_prefix."_field").",'modifiedtime','".$table_prefix."_crmentity',1,'70','modifiedtime','Modified Time',1,0,0,100,25,9,2,'T~O',3,null,'BAS',0,'')");
		$this->db->query("insert into ".$table_prefix."_field values (6,".$this->db->getUniqueID($table_prefix."_field").",'smcreatorid','".$table_prefix."_crmentity',1,'52','creator','Creator',1,2,0,100,27,9,2,'V~O',3,null,'BAS',0,'')");	//crmv@97123
		//crmv@16117 end
		//Block 11
		...
		//Block12
		$this->db->query("insert into ".$table_prefix."_field values (6,".$this->db->getUniqueID($table_prefix."_field").",'description','".$table_prefix."_crmentity',1,'19','description','Description',1,2,0,100,1,12,1,'V~O',1,null,'BAS',1,'')");
		...
		//Block16 -- Start
		$this->db->query("insert into ".$table_prefix."_field values (7,".$this->db->getUniqueID($table_prefix."_field").",'description','".$table_prefix."_crmentity',1,'19','description','Description',1,2,0,100,1,16,1,'V~O',1,null,'BAS',1,'')");
		//Block16 -- End
		...
		//Block8 -- Start
		$this->db->query("insert into ".$table_prefix."_field values (4,".$this->db->getUniqueID($table_prefix."_field").",'description','".$table_prefix."_crmentity',1,'19','description','Description',1,2,0,100,1,8,1,'V~O',2,20,'BAS',1,'')");
		//Block8 -- End
		//Contact Details -- END
		...
		//Block3 -- Start
		$this->db->query("insert into ".$table_prefix."_field values (2,".$this->db->getUniqueID($table_prefix."_field").",'description','".$table_prefix."_crmentity',1,'19','description','Description',1,2,0,100,1,3,1,'V~O',2,8,'BAS',1,'')");
		//Block3 -- End
		...
		$this->db->query("insert into ".$table_prefix."_field values (26,".$this->db->getUniqueID($table_prefix."_field").",'description','".$table_prefix."_crmentity',1,'19','description','Description',1,2,0,100,1,$campaidndescriptionblock,1,'V~O',1,null,'BAS',1,'')");
		...
		$this->db->query("insert into ".$table_prefix."_field values (13,".$this->db->getUniqueID($table_prefix."_field").",'description','".$table_prefix."_crmentity',1,'19','description','Description',1,2,0,100,1,28,1,'V~O',2,5,'BAS',1,'')");
		...
		$this->db->query("insert into ".$table_prefix."_field values (14,".$this->db->getUniqueID($table_prefix."_field").",'product_no','".$table_prefix."_products',1,'4','product_no','Product No',1,0,0,100,2,31,1,'V~O',2,2,'BAS',0,'')");
 		$this->db->query("insert into ".$table_prefix."_field values (14,".$this->db->getUniqueID($table_prefix."_field").",'productcode','".$table_prefix."_products',1,'1','productcode','Part Number',1,2,0,100,4,31,1,'V~O',2,3,'BAS',1,'')");
 		$this->db->query("insert into ".$table_prefix."_field values (14,".$this->db->getUniqueID($table_prefix."_field").",'discontinued','".$table_prefix."_products',1,'56','discontinued','Product Active',1,2,0,100,3,31,1,'V~O',0,11,'BAS',1,'')");
 		...
 		$this->db->query("insert into ".$table_prefix."_field values (14,".$this->db->getUniqueID($table_prefix."_field").",'productcategory','".$table_prefix."_products',1,'15','productcategory','Product Category',1,2,0,100,6,31,1,'V~O',2,4,'BAS',1,'')");
 		$this->db->query("insert into ".$table_prefix."_field values (14,".$this->db->getUniqueID($table_prefix."_field").",'sales_start_date','".$table_prefix."_products',1,'5','sales_start_date','Sales Start Date',1,2,0,100,5,31,1,'D~O',1,null,'BAS',1,'')");
 		$this->db->query("insert into ".$table_prefix."_field values (14,".$this->db->getUniqueID($table_prefix."_field").",'sales_end_date','".$table_prefix."_products',1,'5','sales_end_date','Sales End Date',1,2,0,100,8,31,1,'D~O~OTH~GE~sales_start_date~Sales Start Date',1,null,'BAS',1,'')");
 		$this->db->query("insert into ".$table_prefix."_field values (14,".$this->db->getUniqueID($table_prefix."_field").",'start_date','".$table_prefix."_products',1,'5','start_date','Support Start Date',1,2,0,100,7,31,1,'D~O',1,null,'BAS',1,'')");
 		$this->db->query("insert into ".$table_prefix."_field values (14,".$this->db->getUniqueID($table_prefix."_field").",'expiry_date','".$table_prefix."_products',1,'5','expiry_date','Support Expiry Date',1,2,0,100,10,31,1,'D~O~OTH~GE~start_date~Start Date',1,null,'BAS',1,'')");
		...
		$this->db->query("insert into ".$table_prefix."_field values (14,".$this->db->getUniqueID($table_prefix."_field").",'reorderlevel','".$table_prefix."_products',1,'1','reorderlevel','Reorder Level',1,2,0,100,4,33,1,'I~O',1,null,'BAS',1,'')");
 		$this->db->query("insert into ".$table_prefix."_field values (14,".$this->db->getUniqueID($table_prefix."_field").",'smownerid','".$table_prefix."_crmentity',1,'53','assigned_user_id','Assigned To',1,0,0,100,5,33,1,'I~O',1,null,'BAS',1,'')"); // crmv@109663
		...
		//Block 36 Description Info
 		$this->db->query("insert into ".$table_prefix."_field values (14,".$this->db->getUniqueID($table_prefix."_field").",'description','".$table_prefix."_crmentity',1,'19','description','Description',1,2,0,100,1,36,1,'V~O',2,10,'BAS',1,'')");
		...
		$this->db->query("insert into ".$table_prefix."_field values (10,".$this->db->getUniqueID($table_prefix."_field").",'description','".$table_prefix."_crmentity',1,'19','description','Description',1,0,0,100,1,24,1,'V~O',1,null,'BAS',1,'')");
		...
		$this->db->query("insert into ".$table_prefix."_field values (9,".$this->db->getUniqueID($table_prefix."_field").",'createdtime','".$table_prefix."_crmentity',1,'70','createdtime','Created Time',1,0,0,100,12,19,2,'T~O',3,null,'BAS',0,'')");
 		...
 		$this->db->query("insert into ".$table_prefix."_field values (9,".$this->db->getUniqueID($table_prefix."_field").",'description','".$table_prefix."_crmentity',1,'19','description','Description',1,0,0,100,3,19,1,'V~O',1,null,'BAS',1,'')");
		...
		//Block41-43-- Start
		 ...
		 $this->db->query("insert into ".$table_prefix."_field values (16,".$this->db->getUniqueID($table_prefix."_field").",'description','".$table_prefix."_crmentity',1,'19','description','Description',1,0,0,100,4,39,1,'V~O',1,null,'BAS',1,'')");
		...
		$this->db->query("insert into ".$table_prefix."_field values (18,".$this->db->getUniqueID($table_prefix."_field").",'description','".$table_prefix."_crmentity',1,'19','description','Description',1,2,0,100,1,$vendordescriptionblock,1,'V~O',1,null,'BAS',1,'')");
		...
		$this->db->query("insert into ".$table_prefix."_field values (19,".$this->db->getUniqueID($table_prefix."_field").",'description','".$table_prefix."_crmentity',1,'19','description','Description',1,2,0,100,1,$pricebookdescription,1,'V~O',1,null,'BAS',1,'')");
		...
		//Added fields taxtype, discount percent, discount amount and S&H amount for Tax process
		 ...
		 $this->db->query("insert into ".$table_prefix."_field values (20,".$this->db->getUniqueID($table_prefix."_field").",'description','".$table_prefix."_crmentity',1,'19','description','Description',1,2,0,100,1,$quotedescription,1,'V~O',1,null,'BAS',1,'')");
		...
		//Added fields taxtype, discount percent, discount amount and S&H amount for Tax process
		 ...
		 //Block61
		 $this->db->query("insert into ".$table_prefix."_field values (21,".$this->db->getUniqueID($table_prefix."_field").",'description','".$table_prefix."_crmentity',1,'19','description','Description',1,2,0,100,1,$podescription,1,'V~O',1,null,'BAS',1,'')");
		...
		//Block67
		 $this->db->query("insert into ".$table_prefix."_field values (22,".$this->db->getUniqueID($table_prefix."_field").",'description','".$table_prefix."_crmentity',1,'19','description','Description',1,2,0,100,1,$sodescription,1,'V~O',1,null,'BAS',1,'')");
	...
	// Add fields for the Recurring Information block - Block 86
		...
		//Block73
		 $this->db->query("insert into ".$table_prefix."_field values (23,".$this->db->getUniqueID($table_prefix."_field").",'description','".$table_prefix."_crmentity',1,'19','description','Description',1,2,0,100,1,$invoicedescription,1,'V~O',1,null,'BAS',1,'')");
		 //Block74
		...
		//crmv@29506
		$this->db->query("insert into ".$table_prefix."_field values (29,".$this->db->getUniqueID($table_prefix."_field").",'allow_generic_talks','".$table_prefix."_users',1,'56','allow_generic_talks','Allow generic talks',1,0,0,100,16,$userloginandroleblockid,1,'C~O',1,null,'BAS',1,'')");
		$this->db->query("insert into ".$table_prefix."_field values (29,".$this->db->getUniqueID($table_prefix."_field").",'receive_public_talks','".$table_prefix."_users',1,'56','receive_public_talks','Receive public talks',1,0,0,100,17,$userloginandroleblockid,1,'C~O',1,null,'BAS',1,'')");
		//crmv@29506e
		$this->db->query("insert into ".$table_prefix."_field values (29,".$this->db->getUniqueID($table_prefix."_field").",'notify_me_via','".$table_prefix."_users',1,15,'notify_me_via','Notify me via',1,2,0,100,18,$userloginandroleblockid,1,'V~O',1,null,'BAS',1,'')");	//crmv@29617
		$this->db->query("insert into ".$table_prefix."_field values (29,".$this->db->getUniqueID($table_prefix."_field").",'user_timezone','".$table_prefix."_users',1,15,'user_timezone','Timezone',1,2,0,100,19,$userloginandroleblockid,1,'V~O',1,null,'BAS',1,'')");	//crmv@25610
		$this->db->query("insert into ".$table_prefix."_field values (29,".$this->db->getUniqueID($table_prefix."_field").",'notify_summary','".$table_prefix."_users',1,15,'notify_summary','Notification Summary',1,2,0,100,20,$userloginandroleblockid,1,'V~O',1,null,'BAS',1,'LBL_NOT_SUMMARY_INFO')");	//crmv@29617 //crmv@33465
		$this->db->query("insert into ".$table_prefix."_field values (29,".$this->db->getUniqueID($table_prefix."_field").",'enable_activesync','".$table_prefix."_users',1,56,'enable_activesync','Enable ActiveSync',1,2,0,100,21,$userloginandroleblockid,1,'C~O',1,null,'BAS',1,'')");	//crmv@34873
		// crmv@42024
		...
		$this->db->query("INSERT INTO ".$table_prefix."_field values($email_Tabid,".$this->db->getUniqueID($table_prefix."_field").",'from_email','".$table_prefix."_emaildetails',1,12,'from_email','From',1,2,0,100,1,$blockid,1,'V~M',3,NULL,'BAS',0,'')");	//crmv@2051m
		$this->db->query("INSERT INTO ".$table_prefix."_field values($email_Tabid,".$this->db->getUniqueID($table_prefix."_field").",'to_email','".$table_prefix."_emaildetails',1,8,'saved_toid','To',1,2,0,100,2,$blockid,1,'V~M',3,NULL,'BAS',0,'')");
		$this->db->query("INSERT INTO ".$table_prefix."_field values($email_Tabid,".$this->db->getUniqueID($table_prefix."_field").",'cc_email','".$table_prefix."_emaildetails',1,8,'ccmail','CC',1,2,0,1000,3,$blockid,1,'V~O',3,NULL,'BAS',0,'')");
		$this->db->query("INSERT INTO ".$table_prefix."_field values($email_Tabid,".$this->db->getUniqueID($table_prefix."_field").",'bcc_email','".$table_prefix."_emaildetails',1,8,'bccmail','BCC' ,1,2,0,1000,4,$blockid,1,'V~O',3,NULL,'BAS',0,'')");
		$this->db->query("INSERT INTO ".$table_prefix."_field values($email_Tabid,".$this->db->getUniqueID($table_prefix."_field").",'idlists','".$table_prefix."_emaildetails',1,357,'parent_id','Parent ID' ,1,2,0,1000,5,$blockid,1,'V~O',3,NULL,'BAS',0,'')");
		$this->db->query("INSERT INTO ".$table_prefix."_field values($email_Tabid,".$this->db->getUniqueID($table_prefix."_field").",'email_flag','".$table_prefix."_emaildetails',1,16,'email_flag','Email Flag' ,1,2,0,1000,6,$blockid,3,'V~O',3,NULL,'BAS',0,'')");
		$this->db->query("INSERT INTO ".$table_prefix."_field values($email_Tabid,".$this->db->getUniqueID($table_prefix."_field").",'send_mode','".$table_prefix."_emaildetails',1,1,'send_mode','Send Mode' ,1,2,0,100,7,$blockid,1,'V~O',3,NULL,'BAS',0,'LBL_SEND_MODE_INFO')");	//crmv@26639
		//Emails fields ends
...
//for Customer Portal Login details
	...
	$id = $this->db->getUniqueID($table_prefix.'_emailtemplates');
	$this->db->query("insert into ".$table_prefix."_emailtemplates(foldername,templatename,subject,description,body,deleted,templateid,templatetype,overwrite_message) values ('Public','Il contratto di assistenza scade tra una settimana','VTECRM - contratto in scadenza','Manda una notifica al cliente che il suo contratto di assistenza scade entro una settimana','".$this->db->getEmptyClob(false)."',0,$id,'Email',1)");
	$this->db->updateClob($table_prefix.'_emailtemplates','body',"templateid=$id",$body);
	...
	$id = $this->db->getUniqueID($table_prefix.'_emailtemplates');
	$this->db->query("insert into ".$table_prefix."_emailtemplates(foldername,templatename,subject,description,body,deleted,templateid,templatetype,overwrite_message) values ('Public','Il contratto di assistenza scade tra un mese','VTECRM - contratto in scadenza','Manda una email al cliente un mese prima che scada l''assistenza','".$this->db->getEmptyClob(false)."',0,$id,'Email',1)");
	$this->db->updateClob($table_prefix.'_emailtemplates','body',"templateid=$id",$body);
...
';
	$id = $this->db->getUniqueID($table_prefix.'_emailtemplates');
	$this->db->query("insert into ".$table_prefix."_emailtemplates(foldername,templatename,subject,description,body,deleted,templateid,templatetype,overwrite_message) values ('Public','Tell a friend about VTE','Give a try to the new VTECRM','Give a try to the new VTECRM','".$this->db->getEmptyClob(false)."',0,$id,'Newsletter',1)");
	$this->db->updateClob($table_prefix.'_emailtemplates','body',"templateid=$id",$body);
	//crmv@25391e

	//Insert into vtiger_organizationdetails vtiger_table
	$this->db->query("insert into ".$table_prefix."_organizationdetails(organizationname,address,city,state,country,code,phone,fax,website,logoname,crmv_vat_registration_number) values ('Acme','12 W. Coyote','San Antonio','Texas','U.S.A.','78201','(210) 280-0000','(210) 280-0001','www.acme.inc','logo.png','1234567890')");
	...
	$this->db->query("insert into ".$table_prefix."_version (id,old_version,current_version,enterprise_project,hash_version) values($versionid,'".$vtiger_current_version."','".$vtiger_current_version."',null,".$this->db->getEmptyClob(true).")");
	...
	$vtlanguage->register('it_it','Italian','Italian',true,true,true);
...
//			$this->db->query("insert into vtiger_currencies values(".$this->db->getUniqueID($table_prefix."_currencies").",'$key','".$value[0]."','".$value[1]."')");
//		}
	//crmv@currencies end
	...
	function addEntriesForSettings(){
		...
		$allSettings = array(
			'LBL_MODULE_MANAGER' => array(
				'fields' => array(
					array('name' => 'LBL_WORKFLOW_LIST', 'iconpath' => 'settingsWorkflow.png', 'description' => 'LBL_AVAILABLE_WORKLIST_LIST', 'linkto' => 'index.php?module=com_vtiger_workflow&action=workflowlist', 'sequence' => '1', 'active' => '0')
				)
			), 
			...
			'LBL_STUDIO' => array(
				'fields' => array(
					array('name' => 'VTLIB_LBL_MODULE_MANAGER', 'iconpath' => 'vtlib_modmng.gif', 'description' => 'VTLIB_LBL_MODULE_MANAGER_DESCRIPTION', 'linkto' => 'index.php?module=Settings&action=ModuleManager&parenttab=Settings', 'sequence' => '5', 'active' => '0'), 
					array('name' => 'LBL_MODULE_MAKER', 'iconpath' => 'module_maker.png', 'description' => 'LBL_MODULE_MAKER_DESC', 'linkto' => 'index.php?module=Settings&action=ModuleMaker&parenttab=Settings', 'sequence' => '4', 'active' => '0'), 
					array('name' => 'LBL_CUSTOM_FIELDS', 'iconpath' => 'custom.gif', 'description' => 'LBL_CUSTOM_FIELDS_DESCRIPTION', 'linkto' => 'index.php?module=Settings&action=CustomFieldList&parenttab=Settings', 'sequence' => '16', 'active' => '1'), 
					array('name' => 'LBL_PICKLIST_EDITOR', 'iconpath' => 'picklist.gif', 'description' => 'LBL_PICKLIST_DESCRIPTION', 'linkto' => 'index.php?module=PickList&action=PickList&parenttab=Settings', 'sequence' => '6', 'active' => '0'), 
					array('name' => 'LBL_PICKLIST_EDITOR_MULTI', 'iconpath' => 'picklist_multilanguage.gif', 'description' => 'LBL_PICKLIST_DESCRIPTION_MULTI', 'linkto' => 'index.php?module=Picklistmulti&action=Picklistmulti&parenttab=Settings', 'sequence' => '7', 'active' => '0'), 
					array('name' => 'LBL_EDIT_LINKED_PICKLIST', 'iconpath' => 'linkedpicklist.png', 'description' => 'LBL_EDIT_LINKED_PICKLIST_DESC', 'linkto' => 'index.php?module=Settings&action=LinkedPicklist&parenttab=Settings', 'sequence' => '8', 'active' => '0'), 
					...
					array('name' => 'LBL_LIST_WORKFLOWS', 'iconpath' => 'settingsWorkflow.png', 'description' => 'LBL_LIST_WORKFLOWS_DESCRIPTION', 'linkto' => 'index.php?module=com_vtiger_workflow&action=workflowlist&parenttab=Settings', 'sequence' => '2', 'active' => '0'), 
					array('name' => 'LBL_DATA_IMPORTER', 'iconpath' => 'data_import.png', 'description' => 'LBL_DATA_IMPORTER_DESC', 'linkto' => 'index.php?module=Settings&action=DataImporter&parenttab=Settings', 'sequence' => '15', 'active' => '0'), 
					array('name' => 'LBL_PROCESS_MAKER', 'iconpath' => 'module_maker.png', 'description' => 'LBL_PROCESS_MAKER_DESC', 'linkto' => 'index.php?module=Settings&action=ProcessMaker&parenttab=Settings', 'sequence' => '1', 'active' => '0'), 
					array('name' => 'LBL_WIZARD_MAKER', 'iconpath' => 'module_maker.png', 'description' => 'LBL_WIZARD_MAKER_DESC', 'linkto' => 'index.php?module=Settings&action=WizardMaker&parenttab=Settings', 'sequence' => '3', 'active' => '0'), 
					array('name' => 'LBL_MAIL_SCANNER', 'iconpath' => 'mailScanner.gif', 'description' => 'LBL_MAIL_SCANNER_DESCRIPTION', 'linkto' => 'index.php?module=Settings&action=MailScanner&parenttab=Settings', 'sequence' => '14', 'active' => '0')
				),
				'image' => 'business',
			), 
			...
			'LBL_OTHER_SETTINGS' => array(
				'fields' => array(
					...
					array('name' => 'LBL_ASSIGN_MODULE_OWNERS', 'iconpath' => 'assign.gif', 'description' => 'LBL_MODULE_OWNERS_DESCRIPTION', 'linkto' => 'index.php?module=Settings&action=ListModuleOwners&parenttab=Settings', 'sequence' => '7', 'active' => '0'), 
					...
					array('name' => 'LBL_PRIVACY', 'iconpath' => 'themes/images/PrivacySettings.png', 'description' => 'LBL_PRIVACY_DES', 'linkto' => 'index.php?module=Settings&action=Privacy&parenttab=Settings', 'sequence' => '16', 'active' => '0')
				),
				'image' => 'build',
			)
		);
		...
		if ($adb->table_exist('tbl_s_menu_modules') == 0) {
			...
			$fast_modules = array('Home', 'Leads', 'Accounts', 'Contacts', 'Campaigns', 'HelpDesk', 'Potentials', 'Reports'); // crmv@120738 crmv@124735
			$i = 0;
...
//		Vtiger_Utils::AlterTable($table_prefix.'_eventhandlers',"dependent_on C(255) NOT NULL DEFAULT '[]'");
	}
