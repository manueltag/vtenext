...
function set_password(form) {
	...
	//crmv@28327
	res = getFile('index.php?module=Users&action=UsersAjax&file=CheckPasswordCriteria&record='+parent.document.DetailView.record.value+'&password='+encodeURIComponent(form.new_password.value));	//crmv@38918
	if (res == "no") {
...
?>
	<tr>
		...
		<td width='60%'>
			<div class='dvtCellInfo'>
				<input name='new_password' type='password' tabindex='1' size='15'>
			</div>
		</td>
	</tr>
	<tr>
		...
		<td width='60%'>
			<div class='dvtCellInfo'>
				<input name='confirm_new_password' type='password' tabindex='1' size='15'>
			</div>
		</td>
	</tr>
</table>
