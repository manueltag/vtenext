...
class Quotes extends CRMEntity {
	...
	function save_module()
	{
		...
		// review quote
		if ($_REQUEST['convert_from'] == 'reviewquote' && $_REQUEST['duplicate_from'] > 0) {
		...
		if (vtlib_isModuleActive('Potentials') && !empty($this->column_fields['potential_id']) && in_array($this->column_fields['quotestage'], array('Created', 'Delivered'))) {
