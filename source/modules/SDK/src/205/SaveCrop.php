...
$src_r = ImageCreateTrueColor($_REQUEST['width_image'], $_REQUEST['height_image']);
imagecopyresized($src_r, $img_r, 0, 0, 0, 0, $_REQUEST['width_image'], $_REQUEST['height_image'], $width, $height);
...
imagecopyresampled($dst_r,$src_r,0,0,$_POST['x'],$_POST['y'],$targ_w,$targ_h,$_POST['w'],$_POST['h']);

$current_id = $adb->getUniqueID($table_prefix."_crmentity");
$upload_file_path = decideFilePath();
$new_image = $upload_file_path.$current_id."_".str_replace('.'.$filetype,'',$image_name).'.jpg';
