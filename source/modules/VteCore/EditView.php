...
$smarty->assign('CUSTOM_LINKS', Vtiger_Link::getAllByType(getTabid($currentModule), Array('EDITVIEWWIDGET'), $customlink_params));
//crmv@115268e

$smarty->assign('HIDE_BUTTON_CREATE', true);	//crmv@124738
?>