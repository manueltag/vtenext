...
if (isset ($_REQUEST['isDuplicate']) && $_REQUEST['isDuplicate'] == 'true') {
	...
	//$SO_associated_prod = getAssociatedProducts("SalesOrder", $focus);	//crmv@30721
...
if (isset ($_REQUEST['potential_id']) && $_REQUEST['potential_id'] != '') {
	...
	//$associated_prod = getAssociatedProducts("Potentials", $focus, $focus->column_fields['potential_id']);	//crmv@30721
...
elseif ($focus->mode == 'edit') {
	...
	//$associated_prod = getAssociatedProducts("SalesOrder", $focus);	//crmv@30721
	//$smarty->assign("ASSOCIATEDPRODUCTS", $associated_prod);
	$smarty->assign("MODE", $focus->mode);
