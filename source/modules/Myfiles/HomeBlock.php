...
switch($mode){
	...
	case 'detailview':
		...
		$smarty_minidetailview = new vtigerCRM_Smarty();
		...
		if ($_REQUEST['hide_custom_links'] != '1') {
			...
			$smarty_minidetailview->assign('CUSTOM_LINKS', Vtiger_Link::getAllByType(getTabid($currentModule), Array('DETAILVIEWBASIC','DETAILVIEW','DETAILVIEWWIDGET'), $customlink_params));
		}
		// crmv@42752e
