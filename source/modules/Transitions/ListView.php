...
{
	$role_check_picklist .='<option value="'.$roleid.'">'.$settings_strings[LBL_ROLES].'::'.$rolename[0].'</option>';
	$src_role_check_picklist .='<option value="'.$roleid.'">'.$settings_strings[LBL_ROLES].'::'.$rolename[0].'</option>';
}
