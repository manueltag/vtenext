 		...
 		<tr height="34">
 			<td align="right" width="30%">';
 				if(isPermitted($currentModule, 'EditView') == 'yes')
					$small_page_buttons .= '<input type="button" name="button" title="'.getTranslatedString('LBL_CREATE').'" value="'.getTranslatedString('LBL_CREATE').'" class="crmbutton small create" onClick="MyNotesSV.create(\''.$currentModule.'\')">';
...
if (!empty($_REQUEST['record'])) {
	$_SESSION['mynote_selected'] = $_REQUEST['record'];
}
if (!empty($_SESSION['mynote_selected'])) {
	$smarty->assign('MYNOTE_SELECTED', $_SESSION['mynote_selected']);
} else {
