...
function getTopPotentials($maxval,$calCnt)
{
	...
	$search_qry = "&query=true&Fields0=".$table_prefix."_crmentity.smownerid&Condition0=is&Srch_value0=".$current_user->column_fields['user_name']."&Fields1=".$table_prefix."_potential.sales_stage&Condition1=dcts&Srch_value1=closed&searchtype=advance&search_cnt=2&matchtype=all";
