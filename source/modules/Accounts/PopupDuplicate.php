...
$header = array($mod_strings["Account Name"],$mod_strings["Type"],$mod_strings["Billing City"]);
...
{
	$i++;
  $Entities[$i][1] = "<a href='index.php?module=Accounts&action=DetailView&record=".$row['accountid']."' target='_new'>".$row['accountname']."</a>";
	$Entities[$i][2] = $mod_strings[$row['account_type']];
	$Entities[$i][3] = $row['bill_city'];
}
