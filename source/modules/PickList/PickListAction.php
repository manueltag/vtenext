...
if($mode == 'add'){
	...
	if ($metaLogs) $metaLogs->log($metaLogs::OPERATION_EDITFIELD, getFieldid(getTabid($moduleName), $tableName), array('picklist_action'=>'add')); // crmv@49398
	echo "SUCCESS";
}elseif($mode == 'edit'){
	...
	if ($metaLogs) $metaLogs->log($metaLogs::OPERATION_EDITFIELD, getFieldid(getTabid($moduleName), $tableName), array('picklist_action'=>'edit')); // crmv@49398
	echo "SUCCESS";
}elseif($mode == 'delete'){
	...
	if ($metaLogs) $metaLogs->log($metaLogs::OPERATION_EDITFIELD, getFieldid(getTabid($moduleName), $tableName), array('picklist_action'=>'delete')); // crmv@49398
	echo "SUCCESS";
}
