			...
			if (statusOk && result && result.fields) {
				...
				for (var i=0; i<result.fields.length; ++i) {
					...
					if (result.fields[i].type.name == 'table') {
						...
						describeObjectModLight(fieldname, fieldlabel, v, fields);
					}
				}
...
function VtigerWebservices(serviceUrl, username, accessKey, cacheRequests, show_describe_hidden_fields){	//crmv@120039
