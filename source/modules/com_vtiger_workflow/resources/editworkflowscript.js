...
function editworkflowscript($, conditions){
	...
	var operations = function(){
		//crmv@36510
		var op = {
			string:["is", "contains", "does not contain", "starts with", "ends with", "has changed"],
		...
		var mapping = [
			...
			['date', ['datetime','date']],
			['value', ['reference', 'picklist', 'multipicklist', 'time', 'boolean','picklistmultilanguage','file']] //crmv@95817 crmv@99788
		];
		//crmv@36510 e
	  	var out = {};
