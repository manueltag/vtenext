...
function getModuleNameList()
{
	...
	$sql = "select ".$table_prefix."_moduleowners.*, ".$table_prefix."_tab.name from ".$table_prefix."_moduleowners inner join ".$table_prefix."_tab on ".$table_prefix."_moduleowners.tabid = ".$table_prefix."_tab.tabid WHERE ".$table_prefix."_tab.presence != 1 order by ".$table_prefix."_tab.tabsequence";
	// END
