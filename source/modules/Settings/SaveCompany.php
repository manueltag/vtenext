...
if($org_name=='')
{
	$sql="insert into ".$table_prefix."_organizationdetails values(?,?,?,?,?,?,?,?,?)";
...
{
	$sql="update ".$table_prefix."_organizationdetails set organizationname = ?, address = ?, city = ?, state = ?,  code = ?, country = ?,  phone = ?,  fax = ?,  website = ? where organizationname = ?";
