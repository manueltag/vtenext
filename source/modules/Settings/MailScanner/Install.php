...
if (isModuleInstalled('HelpDesk')) {
	...
	// add links
	Vtiger_Link::addLink($HelpDeskInstance->id, 'DETAILVIEWBASIC', 'Answer by mail', 'javascript:ReplyMailConverter($RECORD$,\'current\');', 'vteicon:reply', 0, $cond);
	Vtiger_Link::addLink($HelpDeskInstance->id, 'DETAILVIEWBASIC', 'Answer by mail (info)', 'javascript:ReplyMailConverter($RECORD$,\'mailconverter\');', 'vteicon:reply', 0, $cond);
