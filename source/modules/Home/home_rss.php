...
$query = "select ".$table_prefix."_crmentity.setype,".$table_prefix."_crmentity.crmid,".$table_prefix."_crmentity.smcreatorid,".$table_prefix."_crmentity.modifiedtime from ".$table_prefix."_crmentity inner join ".$table_prefix."_ownernotify on ".$table_prefix."_crmentity.crmid=".$table_prefix."_ownernotify.crmid";
