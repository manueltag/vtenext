...
$_SESSION['modules_to_update']['SMSNotifier'] = 'packages/vte/beta/vte/SMSNotifier.zip';
...
$_SESSION['modules_to_update']['ProjectsStandard'] = Array('location'=>'packages/vte/mandatory/ProjectsStandard.zip','modules'=>Array('ProjectPlan', 'ProjectTask', 'ProjectMilestone'));
