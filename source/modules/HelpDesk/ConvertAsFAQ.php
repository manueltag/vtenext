...
$sql = " select ticketid, title, product_id,".$table_prefix."_crmentity.description, solution,".$table_prefix."_troubletickets.status, category from ".$table_prefix."_troubletickets inner join ".$table_prefix."_crmentity on ".$table_prefix."_crmentity.crmid=".$table_prefix."_troubletickets.ticketid  where ticketid=?";
