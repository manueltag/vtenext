...
class Geolocalization extends SDKExtendableClass {
	...
	public function vtlib_handler($moduleName, $eventType) {
		...
		if($eventType == 'module.postinstall') {
			...
			// add Javascript
			Vtiger_Link::addLink($sdkInstance->id, 'HEADERSCRIPT', 'SDKScript', 'modules/Geolocalization/Geolocalization.js');
			...
			foreach ($this->installModules as $module) {
				...
				Vtiger_Link::addLink($modInstance->id, 'LISTVIEWBASIC', 'Geolocalization', "VTEGeolocalization.getLocalization('\$MODULE\$');", '', 0, $condition);
			}
