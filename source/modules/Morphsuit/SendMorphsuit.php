...
include('vteversion.php');	//crmv@130421
								...
								<?php } ?>
									...
									<div class="col-xs-6">
										<table class="table borderless">
											...
											<tr><td colspan="2">
												<?php echo $mod_strings['LICENSE_ID'].': <b>'.$saved_morphsuit_id.'</b>'; ?>
											</td></tr>
											<?php } ?>
											<tr><td colspan="2">
									...
									<div class="col-xs-6">
										...
										<?php if ($installation_mode && !$update_mode) { ?>
											...
											<tr>
												<td align="left">
													<label for="email1"><?php echo getTranslatedString('Email','Users'); ?>:</label>
													<div class="dvtCellInfo">
	...
	<?php if ($installation_mode && !$update_mode) { ?>
		if (getObj('file').value != 'MailMorphsuit') {
			...
			if (!emptyCheck('last_name','<?php echo getTranslatedString('Last Name','Users'); ?>',getObj('last_name').type))
				return false;
			if (!emptyCheck('email1','<?php echo getTranslatedString('Email','Users'); ?>',getObj('email1').type))
				return false;
