            ...
            default: // eg. CRYPT_RSA_PRIVATE_FORMAT_PKCS1
                ...
                if (!empty($this->password)) {
                    ...
                    $RSAPrivateKey = "-----BEGIN RSA PRIVATE KEY-----\r\n" .
                                     ...
                                     '-----END RSA PRIVATE KEY-----';
					 */
					$RSAPrivateKey = chunk_split(base64_encode($des->encrypt($RSAPrivateKey)));
					//crmv@18670e
                } else {
					//crmv@18670
					/*
                    $RSAPrivateKey = "-----BEGIN RSA PRIVATE KEY-----\r\n" .
                                     ...
                                     '-----END RSA PRIVATE KEY-----';
					*/
					$RSAPrivateKey = chunk_split(base64_encode($RSAPrivateKey));
					//crmv@18670e
                }
        ...
        switch ($this->publicKeyFormat) {
            ...
            default: // eg. CRYPT_RSA_PUBLIC_FORMAT_PKCS1
                ...
                $RSAPublicKey = "-----BEGIN PUBLIC KEY-----\r\n" .
                                 ...
                                 '-----END PUBLIC KEY-----';
				*/
				$RSAPublicKey = chunk_split(base64_encode($RSAPublicKey));
				//crmv@18670e
                return $RSAPublicKey;
        }
    }
