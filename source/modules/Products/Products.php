	...
	function generateReportsSecQuery($module,$secmodule,$report_type='',$hasInventoryColumns = true) {
		...
		if($report_type !== 'COLUMNSTOTOTAL') {
			$query .= " LEFT JOIN (
				...
				left join ".$table_prefix."_groups ".$table_prefix."_groupsProducts on ".$table_prefix."_groupsProducts.id = ".$table_prefix."_crmentity.smownerid
