...
// crmv@68357 crmv@81126 - support for ical preview, so far only from messages module
if ($_REQUEST['useical'] == 'true' && isset($_REQUEST['icalid']) && $_REQUEST['from_module'] == 'Messages' && $_REQUEST['from_crmid'] > 0) {
	if ($_REQUEST['activityid'] > 0) {
