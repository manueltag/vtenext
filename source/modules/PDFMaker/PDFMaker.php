...
class PDFMaker {
	...
	function vtlib_handler($modulename, $event_type) {
		...
		if($event_type == 'module.postinstall') {
	        ...
	        SDK::setMenuButton('contestual','LBL_ADD_TEMPLATE','window.location=\'index.php?module=PDFMaker&action=EditPDFTemplate\';','add','PDFMaker');
			...
			SDK::setMenuButton('contestual','LBL_EXPORT','return ExportTemplates();','file_upload','PDFMaker','index');
			...
			SDK::setMenuButton('contestual','LBL_EXPORT','return ExportTemplates();','file_upload','PDFMaker','ListPDFTemplates');
