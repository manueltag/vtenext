...
echo '<html>
      ...
      <link rel="stylesheet" href="themes/'.$_SESSION["vtiger_authenticated_user_theme"].'/style.css">
      </head>
      <body leftmargin=0 topmargin=0 marginheight=0 marginwidth=0>';	//crmv@25443
...
$sql = "SELECT * FROM ".$table_prefix."_pdfmaker WHERE templateid IN ($templates)";      
