...
<tr>
	<td width="100%" align="left" class="small level3Bg" id="PDFBreaklineDivHandle" style="padding:5px; cursor:move;">'.$pdf_strings["LBL_PRODUCT_BREAKLINE"].'</td>
</tr>
</table>
<div class="closebutton" onclick="jQuery(\'#PDFBreaklineDiv\').hide();"></div>
...
<tr><td align=center class="small">
	...
	<input type="button" name="'.$app_strings["LBL_CANCEL_BUTTON_LABEL"].'" value="'.$app_strings["LBL_CANCEL_BUTTON_LABEL"].'" class="crmbutton small cancel" onclick="jQuery(\'#PDFBreaklineDiv\').hide();" />
</td></tr>
</table>
</form>
'; 
