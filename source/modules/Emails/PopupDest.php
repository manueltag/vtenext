...
$imgSearch = '<img id="imgSearch" src="themes/'.$theme.'/images/clear_field.gif" alt="'.$mod_strings["LBL_CLEAR"].'" title="'.$mod_strings["LBL_CLEAR"].'" align="absmiddle" style="cursor:hand;cursor:pointer">';
