...
$graph_html = $draw_this->pipeline_by_sales_stage($datax, $date_start, $date_end, $ids, $tmp_dir.$cache_file_name, $refresh,$width,$height);
if (!$graph_html)
	$permission = false;
else
	$permission = true;	
if(isPermitted('Potentials','index')=="yes" && $permission)
{
echo $graph_html;
