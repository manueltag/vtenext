...
function get_existing_entity_runtime_unique_offline($module,$fields_key,$row){
	...
	if (!isset($_SESSION[$module."_offline"]['query_unique'])){
		...
		$_SESSION[$module."_offline"]['query_unique'] = $qry;
		$_SESSION[$module."_offline"]['query_fieldnames'] = $fieldnames;
		$_SESSION[$module."_offline"]['query_params'] = $params;
	}
	$qry = $_SESSION[$module."_offline"]['query_unique'];
	$params = $_SESSION[$module."_offline"]['query_params'];
	foreach ($_SESSION[$module."_offline"]['query_fieldnames'] as $fname){;		$params[] = $row[$fname];
	}
