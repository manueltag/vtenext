...
//array mappaggio capi righe prodotto: nome campo tabella di appoggio => colonna nella tabella vtiger_inventoryproductrel
$mapping_row = Array(
...
$external_code_product = Array('product_external_code'=>'external_code');	//campo tabella row che identifica il prodotto (non la riga prodotto nell'inventory, ma l'entità prodotto) => fieldname del campo External code nel modulo Products
//tabella di appoggio
$table = "erp_quotes";
